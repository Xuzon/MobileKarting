...
namespace KartGame.Track
{
    ...
    public class TimeDisplay : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("Game object of new record")]
        protected GameObject newRecordObject;        
        [SerializeField]
        [Tooltip("Time to display new record")]
        protected int newRecordTime = 5;
        ...
        /// <summary>
        /// Callback on new historical record
        /// </summary>
        private void OnNewRecord()
        {
            System.Collections.IEnumerator DeactivateIn(float time)
            {
            ...
            StartCoroutine(DeactivateIn(newRecordTime));
        }
    }
}